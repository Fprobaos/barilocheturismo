...
XPS = [
  dict(slug='paseo-en-lancha', id='lancha', num='01', kicker=('Lago','Lake'), title=('Paseo en Lancha','Boat Tour'),
    ...
    p1=('Salimos en nuestra lancha privada, con capacidad para hasta nueve personas, y dejamos atrás el ruido del centro. En pocos minutos el lago se abre en brazos y bahías que solo se conocen navegando.',
        'We set out on our private boat, with room for up to nine people, and leave the noise of downtown behind. Within minutes the lake opens into arms and bays you only get to know by sailing.'),
    ...
    facts=[('Duración','Duration','Medio día','Half day'),('Grupo','Group','Hasta 9 personas','Up to 9 people'),('Temporada','Season','Dic — Mar','Dec — Mar'),('Idiomas','Languages','ES · EN','ES · EN')],
    inc=[('Lancha privada para hasta 9 personas','Private boat for up to 9 people'),
    ...
    meta_desc='Navegación privada por bahías, islas y calas turquesa del lago Nahuel Huapi desde Arelauquen, Bariloche. Lancha para hasta 9 personas, medio día, fotos y videos con dron incluidos.',
